...
//        }
        return getWeekInterval(lastYear,lastMonth,lastDay,year,month,day);
    }
     ...
     * @return
     */
    public static int getWeekInterval(int lastYear, int lastMonth, int lastDay,int year, int month, int day) {
...
//        int interval = (int) ((end.getTimeInMillis() - start
...
//                .getTimeInMillis()) / (3600 * 1000 * 24 * 7));
     ...
     * @return
     */
//    public static int getDiffMonths(Date date, Date date1){
//        Calendar calendar = getCalendar(date);
//        int year = calendar.get(Calendar.YEAR);
//        int month = calendar.get(Calendar.MONTH);
//        calendar.setTime(date1);
//        return (year-calendar.get(Calendar.YEAR)-1)*12+month+1+(12-calendar.get(Calendar.MONTH));
//    }
